...
set pumheight=6                        " Makes popup menu smaller
...
autocmd FileType * setlocal formatoptions-=c formatoptions-=r formatoptions-=o         " Removes adding comment in new line.
